...
docker-run: docker-stop
	...
	@echo "\n✅ All services running — ledger :8080, core :8081, processor :8082"

docker-stop:
	docker rm -f ledger core processor 2>/dev/null || true
	docker network rm banking-net 2>/dev/null || true
	@echo "✅ All services stopped"

docker-logs:
	docker logs -f ledger & docker logs -f core & docker logs -f processor
